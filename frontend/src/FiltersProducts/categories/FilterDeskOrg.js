...
function FilterDeskOrg(props) {
    const [categoryData, setCategoryData] = useState([]);


    const retrieveCategory = async () => {
        const response = await axios.get('https://office-essentials-app.herokuapp.com/office-essentials/products/category/Desk Organizer');
